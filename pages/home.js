  ...
  return (
    <div>
              ...
              <div className="col-3">
                <div className="banner-bottom-ineerbox">
                  <ul>
                    <li>
                      <Image
                        src="/assets/images/banner/Group 594.svg"
                        width={60}
                        height={60}
                      />
                    </li>
              ...
              <div className="col-3">
                <div className="banner-bottom-ineerbox">
                  <ul>
                    <li>
                      <Image
                        src="/assets/images/banner/Group 593@2x.png"
                        width={60}
                        height={60}
                      />
                    </li>
              ...
              <div className="col-3">
                <div className="banner-bottom-ineerbox">
                  <ul>
                    <li>
                      <Image
                        src="/assets/images/banner/Group 592.svg"
                        width={60}
                        height={60}
                      />
                    </li>
              ...
              <div className="col-3">
                <div className="banner-bottom-ineerbox">
                  <ul>
                    <li>
                      <Image
                        src="/assets/images/banner/Group 591.svg"
                        width={60}
                        height={60}
                      />
                    </li>
      ...
      <div className="section product-tab-area bg-brown mt-6">
        <div
          className="feature-background pb-100px"
      ...
      <div className="section pt-6 pb-6">
        <div className="container-fluid">
          <div className="row ">
            <div className="col-md-12 text-center" data-aos="fade-up">
              <div className="section-title">
                <h2 className="title" style={{ color: "#1E196C" }}>
                  Shop by Bed Size
                </h2>
              </div>
            </div>
          ...
          <div className="row">
            <div
              className="size-box home-page-icon"
              style={{
                marginBottom: "-14px",
                position: "relative",
                bottom: "12px",
            ...
            >
              <div className="single-box shop-by-size">
                ...
                <p className="text-center mt-2" style={{ color: "#00B2BD" }}>
                  2.6ft Small Single
                </p>
              </div>
      ...
      <div className="section pt-6  bg-lightgray">
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12 text-center" data-aos="fade-up">
              <div className="section-title">
                <h2 className="title colorsecond">New Best Selling Bed</h2>
                <p className="sub-title mb-6" style={{ fontWeight: "600" }}>
                  We’re one of the UK’s leading manufacturers of cheap divan
                  beds, offering a rich selection of products in a variety of
                  styles.
                </p>
              </div>
            </div>
